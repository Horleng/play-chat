...
const Profile = () => {
    ...
    return (
        <>
            {
            !User?"":
            <div className='h-screen md:flex md:gap-4 block lg:mx-[50px] md:mx-[30px] shadow-lg overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-600'>
                <div  className='relative md:flex-1 bg-white dark:bg-slate-700 h-screen pt-5 px-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-600'>
