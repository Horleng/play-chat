...
const Security = (props) => {
    ...
    return (
        <>
            <div className='bg-white dark:bg-slate-700 h-screen md:pt-10 pt-2 container'>
                <div className='mx-auto md:mt-8 mt-5 md:w-[70%] w-[90%] flex justify-center'>
                    <div className='w-[100%]  flex flex-col gap-5 '>
                        ...
                        <button className='bg-blue-700 hover:bg-blue-600' onClick={changeEmailAndPAssword}>{loading?<h1 className='loading'/>:"save"}</button>
                    </div>
                </div>
            </div>
        </>
